 ...
 * @enum {string}
 */
var BillingPostResponseBodyOrganizationTypeEnum;
(function (BillingPostResponseBodyOrganizationTypeEnum) {
 ...
 */
function instanceOfBillingPostResponseBody(value) {
    if (!('organizationId' in value) || value['organizationId'] === undefined)
        return false;
    if (!('organizationType' in value) || value['organizationType'] === undefined)
        return false;
...
function BillingPostResponseBodyFromJSON(json) {
    return BillingPostResponseBodyFromJSONTyped(json, false);
}
function BillingPostResponseBodyFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function BillingPostResponseBodyToJSON(json) {
    return BillingPostResponseBodyToJSONTyped(json, false);
}
function BillingPostResponseBodyToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
