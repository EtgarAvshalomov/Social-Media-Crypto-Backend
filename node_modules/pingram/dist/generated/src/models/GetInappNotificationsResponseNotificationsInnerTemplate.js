 ...
 */
function instanceOfGetInappNotificationsResponseNotificationsInnerTemplate(value) {
...
function GetInappNotificationsResponseNotificationsInnerTemplateFromJSON(json) {
    return GetInappNotificationsResponseNotificationsInnerTemplateFromJSONTyped(json, false);
}
function GetInappNotificationsResponseNotificationsInnerTemplateFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function GetInappNotificationsResponseNotificationsInnerTemplateToJSON(json) {
    return GetInappNotificationsResponseNotificationsInnerTemplateToJSONTyped(json, false);
}
function GetInappNotificationsResponseNotificationsInnerTemplateToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
